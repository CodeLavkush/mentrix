...
describe(
    "GET /api/v1/flashcardsets/:quizAttemptId",
    () => {
        ...
        it(
            "should fetch all flashcard sets successfully",
            async () => {
        ...
        it(
            "should return 404 when flashcard sets are not found",
            async () => {
